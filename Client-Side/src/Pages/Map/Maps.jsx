...
const Maps =()=>{
    ...
    useEffect(() => {
        ...
        const apart1 = document.querySelector('.prop1');
        const apart2 = document.querySelector('.prop2');
        const apart3 = document.querySelector('.prop3');
        const apart4 = document.querySelector('.prop4');
        const apart5 = document.querySelector('.prop5');
        const apart6 = document.querySelector('.prop6');
